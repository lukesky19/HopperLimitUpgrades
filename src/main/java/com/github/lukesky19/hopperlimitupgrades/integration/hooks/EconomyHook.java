...
public class EconomyHook implements Hook {
     ...
     */
    public EconomyHook(@NonNull SkyPlugin skyPlugin) {
    ...
    public void initialize() {
        if(skyPlugin.getServer().getPluginManager().isPluginEnabled("Vault")) {
            RegisteredServiceProvider<Economy> rsp = skyPlugin.getServer().getServicesManager().getRegistration(Economy.class);
            if (rsp != null) {
