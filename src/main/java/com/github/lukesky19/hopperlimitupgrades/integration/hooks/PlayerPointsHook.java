...
public class PlayerPointsHook implements Hook {
     ...
     */
    public PlayerPointsHook(@NonNull SkyPlugin skyPlugin) {
    ...
    public void initialize() {
        if(skyPlugin.getServer().getPluginManager().isPluginEnabled("PlayerPoints")) {
     ...
     */
    public void removeFromBalance(@NonNull Player player, int amount) {
